...
from tkinter import simpledialog, Tk  # for popup input

def send_suspicious_email(receiver_email, activity_name):
    sender_email = "kaleem202120@gmail.com"
    sender_password = "xyljzncebdxcubjq"  # App password

    subject = "Suspicious Activity Detected"
    body = f"Alert!\n\nSuspicious activity '{activity_name}' detected by the system.\n\nPlease check the area immediately.\n\nBest Regards,\nSuspicious Activity Detection System"
    ...
    if request.method == 'POST':
        ...
        while True:
            ...
            if ret:
                ...
                data = np.expand_dims(np.expand_dims(img, axis=0), axis=0)
        ...
        if suspicious_detected:
            ...
            if receiver_email:
                send_suspicious_email(receiver_email, detected_activity)
